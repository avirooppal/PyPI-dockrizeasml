...
class MLDockerizer:
    ...
    def find_model_files(self):
        ...
        return [os.path.relpath(f, self.project_path).replace('\\', '/') for f in self.model_files]
...
def main():
    ...
    dockerizer = MLDockerizer(args.project_path, args.entry_point, args.port, args.python_version, args.extra_installs)
